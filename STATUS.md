...
> 최종 갱신: 2026-07-11 | 갱신 주체: PM (유저 피드백 반영 완료 + 홍보팀 7/9~11 종합 보고 반영)
...
| ID | 작업 | 담당 | 비고 |
|---|---|---|---|
| T-18 | Reddit 카르마 빌드업 | 홍보팀 | Spherun 댓글 답글/카르마 누적 확인 대기, 20~30 도달 시 r/WebGames 게시 |
| 관찰 | T-19 챌린지 반응 대조 | 홍보팀 | 7/9~11 기간 아직 뚜렷한 변동 없음, 계속 관찰 |
...
| T-27 | Long-form devlog (절차생성 BGM 원리 / 난이도 곡선 삼질기) | 소재 보유, **PM 업데이트 확정 후 홍보팀 공유 → devlog #3은 PM이 이어서 작성 예정** |
